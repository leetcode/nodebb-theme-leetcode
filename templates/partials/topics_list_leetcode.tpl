	...
	<li component="category/topic" class="row clearfix {function.generateTopicClass}" <!-- IMPORT partials/data/category.tpl -->>
		...
		<div class="col-md-7 col-sm-9 col-xs-10 content">
			<div class="avatar pull-left">
                <!-- IF topics.showCategoryIconForTopics -->
                <a href="/category/{topics.category.cid}">
                    <img src="{topics.category.image}" class="user-img" title="{topics.category.name}" />
                </a>
                <!-- ELSE -->
                <!-- IF showSelect -->
                ...
                <!-- ENDIF !showSelect -->
                <!-- ENDIF topics.showCategoryIconForTopics -->
			</div>
